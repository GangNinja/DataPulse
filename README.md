...
--> B["Connect to GitHub API"]

B --> C["Fetch Repository Pages"]

C --> D["Parse JSON Response"]

D --> E["Transform Repository Objects"]
...
G -->|Duplicate| I["Skip Repository"]

G -->|Invalid| J["Reject Record"]

H --> K["Insert into PostgreSQL"]

K --> L["Run SQL Transformations"]

L --> M["Calculate Repository Health Score"]

M --> N["Generate Data Quality Report"]
